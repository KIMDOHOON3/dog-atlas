...
const newfoundlandDetail = standardBreedDetailSchema.parse({
  ...
  story: {
    title: "뉴펀들랜드는 왜 큰 힘을 천천히 쓰고 물가에서 사람과 협력할까요?",
    ...
    steps: [
      {
        ...
        imageAlt: "뉴펀들랜드 항구에서 젖은 줄과 어망을 어부에게 옮기는 검은 성견 뉴펀들랜드 삽화",
      },
      {
        navLabel: "현재의 경향",
        eyebrow: "2단계 · 오늘은 어떻게 나타날까?",
        ...
        imageAlt: "해안 길에서 넓은 하네스로 가벼운 빈 수레를 천천히 끌며 보호자의 멈춤 신호를 확인하는 검은 성견 뉴펀들랜드 삽화",
      },
      {
        navLabel: "생활의 현실",
        eyebrow: "3단계 · 보호자는 무엇을 체감할까?",
        ...
        imageAlt: "차가운 물가에서 나온 뒤 젖은 검은 성견 뉴펀들랜드가 큰 매트에 누워 물을 마시며 쉬는 삽화",
      },
    ],
