...
export const masterSources = masterSourceCollectionSchema.parse([
  ...
  {
    id: "kusa-boerboel",
    title: "Boerboel Breed Standard",
    organization: "Kennel Union of Southern Africa (KUSA)",
    url: "https://kusa.co.za/images/Gallery/Boerboel%20Breed%20Standard.pdf",
    checkedAt: "2026-08-17",
    scope: "breed-standard",
  },
  {
    id: "akc-anatolian-shepherd-dog",
    title: "Anatolian Shepherd Dog Breed Information",
    organization: "American Kennel Club (AKC)",
  ...
  {
    id: "fci-kangal-shepherd-dog",
    title: "Kangal Shepherd Dog — FCI Standard No. 331",
    organization: "Fédération Cynologique Internationale (FCI)",
