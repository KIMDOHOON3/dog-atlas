...
const aliasesKo: Partial<Record<string, string[]>> = {
  ...
  "portuguese-water-dog": ["포르투갈 워터 도그", "포르투기즈 워터 도그", "포르투기스 워터독"],
  ...
  "miniature-schnauzer": ["미니어쳐 슈나우저", "미니어처 슈나우져", "미니슈나"],
  ...
  "cavalier-king-charles-spaniel": ["카발리에 킹 찰스 스파니엘", "카발리에 킹 찰스 스패니얼", "캐벌리어 킹 찰스 스파니엘"],
  "alaskan-malamute": ["알라스칸 말라뮤트", "알래스칸 맬러뮤트", "알래스칸 멜러뮤트", "말라뮤트", "맬러뮤트", "멜러뮤트"],
  "nova-scotia-duck-tolling-retriever": ["노바스코셔 덕 톨링 리트리버", "노바스코샤 덕톨링 리트리버", "노바 스코티아 덕 톨링 리트리버", "톨러"],
  "cane-corso": ["케인 코르소", "케인 코르소 이탈리아노", "카네 코르소 이탈리아노"],
  "australian-kelpie": ["오스트레일리언 켈피"],
  "australian-cattle-dog": ["오스트레일리언 캐틀독", "오스트레일리언 캐틀 독"],
  "australian-shepherd": ["오스트레일리언 셰퍼드"],
  "german-short-haired-pointing-dog": ["저먼 숏헤어드 포인터", "저먼 쇼트헤어드 포인팅 독", "저먼 숏헤어드 포인팅독"],
  "english-springer-spaniel": ["잉글리쉬 스프링거 스파니엘", "잉글리시 스프링거 스파니엘"],
  havanese: ["하바네즈", "하바네스"],
  "scottish-terrier": ["스코티쉬 테리어", "스코티"],
  "norwegian-elkhound-grey": ["노르웨이 엘크하운드", "노르위전 엘크하운드", "엘크하운드"],
  "coton-de-tulear": ["코톤 드 툴레아르", "코튼 드 툴레아", "꼬동 드 툴레아", "꼬똥 드 툴레아르"],
  "staffordshire-bull-terrier": ["스태포드셔 불 테리어", "스타포드셔 불 테리어"],
  "rhodesian-ridgeback": ["로데시안 리지백", "로디지언 리지백", "로디지안 리즈백"],
  "brittany-spaniel": ["브리타니", "브리타니 스파니엘", "브리타니 스패니얼"],
  "irish-red-setter": ["아이리시 세터", "아이리쉬 세터", "아이리쉬 레드 세터"],
  "lagotto-romagnolo": ["라고토 로마그놀로", "라고토 로마놀로", "로마냐 워터독"],
  "irish-wolfhound": ["아이리쉬 울프하운드"],
  "finnish-lapponian-dog": ["핀니시 라포니안 독", "피니시 라프훈트", "핀란드 라프훈트", "핀란드 라프훈드"],
  schnauzer: ["스탠다드 슈나우저"],
  "tibetan-mastiff": ["티베트 마스티프"],
  "italian-pointing-dog": ["이탈리안 포인터"],
  barbet: ["바베트"],
...
const varieties: Partial<Record<string, BreedVariety[]>> = {
  ...
  "german-spitz": [
    ...
    variety("pomeranian", "포메라니안", "Pomeranian", ["포메", "포메라니언", "포메리안", "포메라이언"]),
  ],
  poodle: [
