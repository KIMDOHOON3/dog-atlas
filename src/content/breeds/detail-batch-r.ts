...
export const detailBatchR = [
  ...
  },
  {
    ...
    nameKo: "말티푸",
    nameEn: "Maltipoo",
    tagline: "작고 둥근 인상보다 먼저, 몰티즈와 푸들의 어떤 크기·피모·행동을 물려받았는지 개체별로 확인해야 해요.",
    palette: { primary: "#d9b985", secondary: "#eee3d4", ink: "#3d332b" },
    illustration: "/illustrations/v2/maltipoo-card.webp",
    catalog: { group: "companion", discoveryTags: ["몰티즈·푸들 교배", "소형 반려견", "엉킴·미용 관리"] },
    historyVisual: {
      src: "/illustrations/v3/maltipoo-history.webp",
      alt: "몰티즈와 토이·미니어처 푸들을 바탕으로 형성된 말티푸의 현대적 배경을 그린 편집 수채화",
    },
    identity: {
      origin: "현대 북미권에서 널리 알려진 교배 유형",
      lineage: "몰티즈와 토이 또는 미니어처 푸들을 의도적으로 교배한 디자이너 교배견",
      originalRole: "작은 체격과 사람 곁의 반려 특성을 기대하며 이루어진 현대 교배",
      size: "소형이 일반적이나 부모 푸들의 크기와 교배 세대에 따라 차이",
      lifespan: "교배 유형 전체에 적용할 표준 수명 범위는 확립되지 않음",
    },
    behaviorClues: {
      originalRole: "오랫동안 사람 곁의 반려견이었던 몰티즈와 여러 크기로 정립된 푸들을 교배해 작은 반려견을 얻으려는 현대적 맥락이 있습니다.",
    ...
    story: {
      opening: "말티푸는 몰티즈와 토이 또는 미니어처 푸들을 교배한 이름입니다. 독립 등록 견종의 고정 표준이 아니므로 털의 굵기와 곱슬 정도, 체형과 성격이 한 모습으로 이어지지 않습니다.",
    ...
    careNotes: [
      ...
      "부모 몰티즈와 푸들의 슬개골·눈 등 권장 건강검사 결과가 실제 부모견 이름으로 공개되는지 확인하세요.",
    ],
    ...
    related: [
      { slug: "maltese", reason: "부모견 몰티즈의 작은 체격과 직모 관리가 말티푸에서 어떻게 달리 나타날 수 있는지 살펴보세요." },
