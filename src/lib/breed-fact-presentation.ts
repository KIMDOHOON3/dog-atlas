...
const breedFactOverrides: Record<string, BreedFactOverride> = {
  ...
  "american-pit-bull-terrier": { size: "암컷 약 43~51cm · 수컷 약 46~53cm · 14~27kg", height: "암컷 약 43~51cm · 수컷 약 46~53cm", weight: "14~27kg" },
  "american-bully": { size: "유형·성별 약 33~58cm · 고정 기준 없음", height: "유형·성별 약 33~58cm", weight: "고정 기준 없음" },
  "blue-picardy-spaniel": { size: "53~64cm · 고정 기준 없음", height: "53~64cm", weight: "고정 기준 없음" },
  "field-spaniel": { size: "약 46cm · 18~25kg", height: "약 46cm", weight: "18~25kg" },
  "sussex-spaniel": { size: "이상적 38~41cm · 약 23kg", height: "이상적 38~41cm", weight: "약 23kg" },
  wetterhoun: { size: "55~59cm · 28~34kg", height: "55~59cm", weight: "28~34kg" },
  "drentsche-patrijshond": { size: "55~63cm · 25~35kg", height: "55~63cm", weight: "25~35kg" },
  "griffon-bruxellois": { size: "체고 고정 기준 없음 · 3.5~6kg", height: "고정 기준 없음", weight: "3.5~6kg" },
  "petit-brabancon": { size: "체고 고정 기준 없음 · 3.5~6kg", height: "고정 기준 없음", weight: "3.5~6kg" },
  "russian-toy": { size: "22~27cm · 3kg 이하", height: "22~27cm", weight: "3kg 이하" },
  ...
  lowchen: { size: "26~32cm(±1cm) · 약 6kg", height: "26~32cm(±1cm)", weight: "약 6kg" },
  "english-toy-spaniel": { size: "체고 고정 기준 없음 · 3.6~6.3kg", height: "고정 기준 없음", weight: "3.6~6.3kg" },
  "scottish-deerhound": { size: "암컷 71cm 이상 · 수컷 76cm 이상 · 약 36.5~45.5kg", height: "암컷 71cm 이상 · 수컷 76cm 이상", weight: "약 36.5~45.5kg" },
  "hungarian-greyhound": { size: "암컷 62~67cm · 수컷 65~70cm · 고정 기준 없음", height: "암컷 62~67cm · 수컷 65~70cm", weight: "고정 기준 없음" },
  "catalan-sheepdog": { size: "암컷 45~53cm · 수컷 47~55cm · 고정 기준 없음", height: "암컷 45~53cm · 수컷 47~55cm", weight: "고정 기준 없음" },
  "croatian-sheepdog": { size: "암컷 43~48cm · 수컷 45~50cm(±3cm) · 고정 기준 없음", height: "암컷 43~48cm · 수컷 45~50cm(±3cm)", weight: "고정 기준 없음" },
  kuvasz: { size: "암컷 66~70cm · 수컷 71~76cm · 37~62kg", height: "암컷 66~70cm · 수컷 71~76cm", weight: "37~62kg" },
  schapendoes: { size: "암컷 40~47cm · 수컷 43~50cm · 고정 기준 없음", height: "암컷 40~47cm · 수컷 43~50cm", weight: "고정 기준 없음" },
  "portuguese-sheepdog": { size: "암컷 42~52cm · 수컷 45~55cm · 17~27kg", height: "암컷 42~52cm · 수컷 45~55cm", weight: "17~27kg" },
  "maremma-sheepdog": { size: "암컷 62~70cm · 수컷 67~73.5cm · 35~52kg", height: "암컷 62~70cm · 수컷 67~73.5cm", weight: "35~52kg" },
