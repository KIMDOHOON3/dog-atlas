...
describe("master breed catalog", () => {
  ...
  it("contains the 160-breed discovery inventory and the forty detailed breeds", () => {
  ...
  it("reports catalog status without depending on UI data", () => {
    expect(getMasterCatalogStats()).toEqual({
      ...
      detailPriority: { core: 5, next: 35, later: 120 },
      detailStatus: { published: 40, planned: 0, none: 120 },
    });
  });
