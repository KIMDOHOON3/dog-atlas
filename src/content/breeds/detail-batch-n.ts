...
const makeBreed = (seed: Seed): Breed => {
  ...
  return {
    ...
    behaviorClues: {
      originalRole: `${seed.nameKo}는 ${seed.role}을 위해 형성된 배경이 있습니다. 과거의 역할이 현재 개체의 행동을 보장하지는 않지만 생활 과제를 설계할 때 참고가 될 수 있습니다.`,
    ...
    story: {
      opening: `${seed.nameKo}는 ${seed.origin}에서 ${seed.role}을 맡으며 발전한 품종입니다. 이름이나 외형만으로 생활 적합성을 단정하기보다 형성 배경과 개체의 신호를 함께 살펴보세요.`,
