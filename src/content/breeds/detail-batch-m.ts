...
const historySources: Partial<Record<string, Breed["sources"]>> = {
  ...
  "large-munsterlander": [{ title: "Large Munsterlander FCI breed standard PDF", organization: "Fédération Cynologique Internationale", url: "https://www.fci.be/Nomenclature/Standards/118g07-en.pdf", checkedAt: "2026-08-31" }],
  "irish-red-and-white-setter": [{ title: "Irish Red and White Setter FCI breed standard PDF", organization: "Fédération Cynologique Internationale", url: "https://www.fci.be/Nomenclature/Standards/330g07-en.pdf", checkedAt: "2026-08-31" }],
  "hungarian-wirehaired-vizsla": [{ title: "Hungarian Wire-Haired Pointer FCI breed standard PDF", organization: "Fédération Cynologique Internationale", url: "https://www.fci.be/Nomenclature/Standards/239g07-en.pdf", checkedAt: "2026-08-31" }],
};
...
const seeds: Seed[] = [
  ...
  { slug: "large-munsterlander", nameKo: "라지 뮌스터랜더", nameEn: "Large Munsterlander", group: "pointing", origin: "독일", role: "들판·숲·물에서 새를 찾고 가리키며 회수", size: "대형 · 암컷 58~63cm, 수컷 60~65cm(+2cm 허용), 약 30kg", fciUrl: "https://www.fci.be/en/nomenclature/LARGE-MUNSTERLANDER-118.html" },
  { slug: "irish-red-and-white-setter", nameKo: "아이리시 레드 앤 화이트 세터", nameEn: "Irish Red and White Setter", group: "pointing", origin: "아일랜드", role: "들판에서 들새의 위치를 찾아 멈춰 알리는 포인팅", size: "대형 · 암컷 57~61cm, 수컷 62~66cm, FCI 고정 몸무게 없음", fciUrl: "https://www.fci.be/en/nomenclature/IRISH-RED-AND-WHITE-SETTER-330.html" },
  { slug: "hungarian-wirehaired-vizsla", nameKo: "헝가리안 와이어헤어드 비즐라", nameEn: "Hungarian Wirehaired Vizsla", group: "pointing", origin: "헝가리", role: "들판·숲·물에서 찾기·포인팅·회수를 맡는 다목적 작업", size: "대형 · 암컷 54~60cm, 수컷 58~64cm, FCI 고정 몸무게 없음", fciUrl: "https://www.fci.be/en/nomenclature/HUNGARIAN-WIRE-HAIRED-POINTER-239.html" },
];
