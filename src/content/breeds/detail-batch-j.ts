...
const historyAltOverrides: Partial<Record<string, string>> = {
  ...
  "dogue-de-bordeaux": "19세기 프랑스 정육점 마당에서 정육업자와 작은 짐수레 곁을 지키는 황갈색 도그 드 보르도를 그린 편집 수채화",
  "neapolitan-mastiff": "나폴리 지역의 돌담 농장 뜰에서 관리인과 함께 대문을 지키는 청회색 네아폴리탄 마스티프를 그린 편집 수채화",
  "continental-bulldog": "스위스의 완만한 공원 길에서 사육자와 힘차게 걷는 브린들 컨티넨탈 불독을 그린 편집 수채화",
  "smooth-fox-terrier": "영국 들판의 여우굴 입구에서 사냥꾼의 신호를 기다리는 스무드 폭스 테리어를 그린 편집 수채화",
  "wire-fox-terrier": "영국의 거친 생울타리와 여우굴 앞에서 사냥꾼의 신호를 기다리는 와이어 폭스 테리어를 그린 편집 수채화",
  "kerry-blue-terrier": "아일랜드 농장의 돌담과 물가 사이에서 농부 곁에 선 청회색 케리 블루 테리어를 그린 편집 수채화",
  "cairn-terrier": "스코틀랜드 하이랜드의 돌무더기 틈을 농부와 함께 살피는 모래색 케언 테리어를 그린 편집 수채화",
  "norfolk-terrier": "동앵글리아의 마구간에서 말 장구와 건초 상자 주변을 살피는 붉은 노퍽 테리어를 그린 편집 수채화",
  "norwich-terrier": "19세기 케임브리지의 마구간 딸린 학생 숙소에서 책과 나무 상자 곁을 살피는 붉은 노리치 테리어를 그린 편집 수채화",
  "miniature-bull-terrier": "19세기 영국 마구간에서 사람 곁의 나무 상자와 건초 주변 냄새를 살피는 흰 미니어처 불테리어를 그린 편집 수채화",
};
const historySources: Partial<Record<string, Breed["sources"]>> = {
  ...
  "dogue-de-bordeaux": [{ title: "Dogue de Bordeaux History", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/dog-breeds/dogue-de-bordeaux-history-behind-the-breed/", checkedAt: "2026-08-30" }],
  "neapolitan-mastiff": [{ title: "Neapolitan Mastiff History", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/dog-breeds/neapolitan-mastiff-history/", checkedAt: "2026-08-30" }],
  "smooth-fox-terrier": [{ title: "Smooth Fox Terrier Breed Information", organization: "American Kennel Club", url: "https://www.akc.org/dog-breeds/smooth-fox-terrier/", checkedAt: "2026-08-30" }],
  "kerry-blue-terrier": [{ title: "Kerry Blue Terrier History", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/dog-breeds/kerry-blue-terrier-history/", checkedAt: "2026-08-30" }],
  "cairn-terrier": [{ title: "Cairn Terrier Facts", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/lifestyle/fun-facts-cairn-terrier/", checkedAt: "2026-08-30" }],
  "norfolk-terrier": [{ title: "Norfolk Terrier Facts", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/lifestyle/fun-facts-norfolk-terriers/", checkedAt: "2026-08-30" }],
  "norwich-terrier": [{ title: "Norwich Terrier Characteristics", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/lifestyle/characteristics-of-the-norwich-terrier/", checkedAt: "2026-08-30" }],
  "miniature-bull-terrier": [{ title: "Miniature Bull Terrier History", organization: "American Kennel Club", url: "https://www.akc.org/expert-advice/dog-breeds/miniature-bull-terrier-history/", checkedAt: "2026-08-30" }],
};
...
const seeds: Seed[] = [
  { slug: "belgian-groenendael", nameKo: "그로넨달", nameEn: "Belgian Shepherd Dog (Groenendael)", group: "herding", tags: ["벨기에 목양견", "검은 장모", "높은 학습 욕구"], colors: ["#3d403d", "#d9ded6", "#202421"], origin: "벨기에", lineage: "FCI 벨지안 셰퍼드 독의 검은 장모 변종", role: "가축을 모으고 농장과 사람 주변을 지키는 다목적 목양", size: "중대형 · 약 56~66cm, 20~30kg", lifespan: "약 12~14년", levels: ["높은 편", "높은 편", "중간", "높은 편", "높은 편", "높은 편"], care: ["매일 걷기와 냄새·신호 과제를 함께 제공하세요.", "낯선 자극을 관찰할 안전한 거리를 보장하세요.", "검은 장모와 풍성한 속털이 엉키지 않도록 피부까지 나누어 빗질하세요."], related: [["belgian-tervueren", "같은 장모 변종이지만 피모 색과 검은 오버레이의 차이를 비교할 수 있어요."], ["belgian-malinois", "같은 벨지안 셰퍼드 계통에서 장모와 단모의 생활 관리 차이를 볼 수 있어요."]], fciUrl: "https://www.fci.be/en/nomenclature/BELGIAN-SHEPHERD-DOG-15.html", akcUrl: "https://www.akc.org/dog-breeds/belgian-sheepdog/" },
  { slug: "belgian-laekenois", nameKo: "라케노이즈", nameEn: "Belgian Shepherd Dog (Laekenois)", group: "herding", tags: ["벨기에 목양견", "거친 황갈색 털", "높은 학습 욕구"], colors: ["#aa8a61", "#e2d8c8", "#3a3028"], origin: "벨기에", lineage: "FCI 벨지안 셰퍼드 독의 거친 털 변종", role: "가축을 모으고 농장과 사람 주변을 지키는 다목적 목양", size: "중대형 · 약 56~66cm, 20~30kg", lifespan: "약 10~12년", levels: ["높은 편", "높은 편", "중간", "높은 편", "높은 편", "높은 편"], care: ["매일 걷기와 냄새·신호 과제를 함께 제공하세요.", "낯선 자극을 관찰할 안전한 거리를 보장하세요.", "거칠고 건조한 피모의 결을 유지하도록 정기적인 빗질과 전문 관리를 계획하세요."], related: [["belgian-malinois", "같은 황갈색 계열이지만 거친 털과 짧은 털의 관리 차이가 커요."], ["belgian-tervueren", "같은 벨지안 셰퍼드 계통에서 거친 털과 장모의 차이를 볼 수 있어요."]], fciUrl: "https://www.fci.be/en/nomenclature/BELGIAN-SHEPHERD-DOG-15.html", akcUrl: "https://www.akc.org/dog-breeds/belgian-laekenois/" },
  { slug: "belgian-malinois", nameKo: "말리노이즈", nameEn: "Belgian Shepherd Dog (Malinois)", group: "herding", tags: ["벨기에 목양견", "짧은 황갈색 털", "높은 학습 욕구"], colors: ["#9a7957", "#ded3c3", "#302923"], origin: "벨기에", lineage: "FCI 벨지안 셰퍼드 독의 단모 변종", role: "가축을 모으고 농장과 사람 주변을 지키는 다목적 목양", size: "중대형 · 약 56~66cm, 20~30kg", lifespan: "약 14~16년", levels: ["높은 편", "높은 편", "중간", "높은 편", "높은 편", "중간"], care: ["강도 높은 운동만 반복하지 말고 냄새 탐색·학습·회복을 함께 구성하세요.", "빠른 반응과 큰 힘을 다룰 수 있도록 보상 기반 교육과 안전한 거리를 준비하세요.", "짧은 털도 털갈이와 피부·발·귀 상태를 규칙적으로 확인하세요."], related: [["belgian-laekenois", "같은 황갈색 계열이지만 단모와 거친 털의 관리 차이를 볼 수 있어요."], ["dutch-shepherd-dog", "높은 작업 욕구를 공유하지만 피모와 품종 배경이 달라요."]], fciUrl: "https://www.fci.be/en/nomenclature/BELGIAN-SHEPHERD-DOG-15.html", akcUrl: "https://www.akc.org/dog-breeds/belgian-malinois/" },
  { slug: "belgian-tervueren", nameKo: "테르뷰런", nameEn: "Belgian Shepherd Dog (Tervueren)", group: "herding", tags: ["벨기에 목양견", "황갈색 장모", "높은 학습 욕구"], colors: ["#886d51", "#ddd5c7", "#312b26"], origin: "벨기에", lineage: "FCI 벨지안 셰퍼드 독의 황갈색 장모 변종", role: "가축을 모으고 농장과 사람 주변을 지키는 다목적 목양", size: "중대형 · 약 56~66cm, 20~30kg", lifespan: "약 12~14년", levels: ["높은 편", "높은 편", "중간", "높은 편", "높은 편", "높은 편"], care: ["매일 걷기와 냄새·신호 과제를 함께 제공하세요.", "낯선 자극을 관찰할 안전한 거리를 보장하세요.", "긴 털과 목 주변의 풍성한 피모가 엉키지 않도록 규칙적으로 빗질하세요."], related: [["belgian-groenendael", "같은 장모 변종이지만 피모 색과 검은 오버레이가 달라요."], ["belgian-malinois", "같은 벨지안 셰퍼드 계통에서 장모와 단모의 관리 차이를 볼 수 있어요."]], fciUrl: "https://www.fci.be/en/nomenclature/BELGIAN-SHEPHERD-DOG-15.html", akcUrl: "https://www.akc.org/dog-breeds/belgian-tervuren/" },
  ...
  { slug: "continental-bulldog", nameKo: "컨티넨탈 불독", nameEn: "Continental Bulldog", group: "companion", tags: ["스위스 불독", "활동적인 반려", "호흡 관찰"], colors: ["#ad8e75", "#e3d8c9", "#3b302a"], origin: "스위스", lineage: "현대 스위스에서 형성된 불독 타입", role: "가정 반려와 일상 동행", size: "중형 · 약 40~50cm, 20~30kg", lifespan: "약 10~12년 (FCI 참고, 개체별 차이 있음)", levels: ["중간", "중간", "중간", "높은 편", "중간", "낮은 편"], care: ["짧은 주둥이의 호흡과 더위 반응을 산책 전후 확인하세요.", "체중이 늘지 않도록 짧고 규칙적인 활동을 구성하세요.", "피부와 발, 치아를 일상 핸들링에 익숙하게 하세요."], related: [["bulldog", "불독 타입의 반려 배경을 공유하며 체형과 활동량 차이를 비교해 보세요."], ["french-bulldog", "짧은 주둥이 관리와 사람 곁의 생활을 함께 살펴볼 수 있어요."]], fciUrl: "https://www.fci.be/en/nomenclature/CONTINENTAL-BULLDOG-369.html", akcUrl: "https://www.ukcdogs.com/continental-bulldog" },
  ...
  { slug: "cairn-terrier", nameKo: "케언 테리어", nameEn: "Cairn Terrier", group: "terrier", tags: ["스코틀랜드 소형 테리어", "바위틈 추적", "거친 털"], colors: ["#a58a62", "#ded6c6", "#3b342d"], origin: "스코틀랜드", lineage: "돌무더기 사이 해충을 찾던 하이랜드 테리어", role: "바위틈과 굴에서 작은 동물을 찾아내는 작업", size: "소형 · 약 28~31cm, 6~7.5kg", lifespan: "약 13~15년 (AKC 참고, 개체별 차이 있음)", levels: ["높은 편", "높은 편", "중간", "중간", "중간", "중간"], care: ["작은 동물과의 추적 상황을 리드와 울타리로 관리하세요.", "안전한 파기 상자와 냄새 찾기로 본능을 전환하세요.", "거친 털은 피부까지 닿는 빗질과 정기 트리밍이 필요해요."], related: [["west-highland-white-terrier", "스코틀랜드 소형 테리어의 굴 작업과 거친 털을 공유해요."], ["norfolk-terrier", "작은 체격과 쥐·여우 추적 경향을 비교해 보세요."]], fciUrl: "https://www.fci.be/en/nomenclature/CAIRN-TERRIER-4.html", akcUrl: "https://www.akc.org/dog-breeds/cairn-terrier/" },
