...
Keep the card homepage (eleven small and eight giant cards), all discovery/search/filter behavior, every breed detail and its content/assets. Preserve the preparation guide linked from details. Medium and large groups currently show an empty state; their cards and detail redesign are future work.
