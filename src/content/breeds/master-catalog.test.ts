...
describe("master breed catalog", () => {
  ...
  it("contains the 160-breed discovery inventory and the fifty detailed breeds", () => {
  ...
  it("reports catalog status without depending on UI data", () => {
    expect(getMasterCatalogStats()).toEqual({
      ...
      detailPriority: { core: 5, next: 45, later: 110 },
      detailStatus: { published: 50, planned: 0, none: 110 },
    });
  });
